...
class ReportForAccountsDeptTest {
    ...
    void whenReportIsGeneratedForAccountants() {
        ...
        Employee employee1
                ...
                new GregorianCalendar(2017, Calendar.JANUARY, 1),
                100, currencyConverter.convert(sourceCurrency, 100, targetCurrency));
    ...
    void whenReportIsGeneratedForAccountantsJSON() {
        ...
        Employee employee1
                ...
                new GregorianCalendar(2017, Calendar.JANUARY, 1),
                100,
                currencyConverter.convert(sourceCurrency, 100, targetCurrency));
        store.add(employee1);
    ...
    @Test
    void whenReportIsGeneratedForAccountantsXML() throws JAXBException {
        Store store = new MemoryStore();
        DateTimeParser<Calendar> dateTimeParser = new ReportDateTimeParser();
        CurrencyConverter currencyConverter = new InMemoryCurrencyConverter();
        Currency sourceCurrency = Currency.RUB;
        ...
        Report report = new ReportForAccountsDept(store, dateTimeParser,
                currencyConverter, sourceCurrency, targetCurrency, context);
