...
public class InMemoryCurrencyConverter implements CurrencyConverter {
    ...
    public InMemoryCurrencyConverter() {
        this.conversationTable[Currency.RUB.ordinal()][Currency.USD.ordinal()] = 1;
        this.conversationTable[Currency.RUB.ordinal()][Currency.EUR.ordinal()] = 1;
        this.conversationTable[Currency.USD.ordinal()][Currency.EUR.ordinal()] = 1;
        this.conversationTable[Currency.USD.ordinal()][Currency.RUB.ordinal()] = 100D;
        this.conversationTable[Currency.EUR.ordinal()][Currency.USD.ordinal()] = 1;
